...
if ( ! class_exists( 'YITH_WCAF_Affiliates_Table' ) ) {
	...
	class YITH_WCAF_Affiliates_Table extends WP_List_Table {
		...
		public function column_status( $item ) {
			...
			$human_friendly_status = ( $enabled ) ? __( 'Enabled', 'yith-woocommerce-affiliates' ) : __( 'Disabled', 'yith-woocommerce-affiliates' );
		...
		public function get_views() {
			...
			return array(
				'all' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', esc_url( add_query_arg( 'status', 'all', $tab_url ) ), $current == 'all' ? 'current' : '', __( 'All', 'yith-woocommerce-affiliates' ), YITH_WCAF_Affiliate_Handler()->per_status_count( 'all' )  ),
				'enabled' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', esc_url( add_query_arg( 'status', 'enabled', $tab_url ) ), $current == 'enabled' ? 'current' : '', __( 'Enabled', 'yith-woocommerce-affiliates' ), YITH_WCAF_Affiliate_Handler()->per_status_count( 'enabled' )  ),
				'disabled' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', esc_url( add_query_arg( 'status', 'disabled', $tab_url ) ), $current == 'disabled' ? 'current' : '', __( 'Disabled', 'yith-woocommerce-affiliates' ), YITH_WCAF_Affiliate_Handler()->per_status_count( 'disabled' )  )
			);
		}
		...
		public function get_bulk_actions() {
			$actions = array(
				...
				'enable' => __( 'Enable', 'yith-woocommerce-affiliates' ),
				'disable' => __( 'Disabled', 'yith-woocommerce-affiliates' )
			);
			return $actions;
		}
