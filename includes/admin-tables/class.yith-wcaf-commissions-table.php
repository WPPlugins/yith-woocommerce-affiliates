...
if ( ! class_exists( 'YITH_WCAF_Commissions_Table' ) ) {
	...
	class YITH_WCAF_Commissions_Table extends WP_List_Table {
		...
		public function get_views() {
			...
			return array(
				'all' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'all' ), $current == 'all' ? 'current' : '', __( 'All', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'all' )  ),
				'pending' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'pending' ), $current == 'pending' ? 'current' : '', __( 'Pending', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'pending' )  ),
				'pending-payment' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'pending-payment' ), $current == 'pending-payment' ? 'current' : '', __( 'Pending Payment', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'pending-payment' )  ),
				'paid' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'paid' ), $current == 'paid' ? 'current' : '', __( 'Paid', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'paid' )  ),
				'not-confirmed' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'not-confirmed' ), $current == 'not-confirmed' ? 'current' : '', __( 'Not Confirmed', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'not-confirmed' )  ),
				'cancelled' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'cancelled' ), $current == 'cancelled' ? 'current' : '', __( 'Cancelled', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'cancelled' )  ),
				'refunded' => sprintf( '<a href="%s" class="%s">%s <span class="count">(%s)</span></a>', add_query_arg( 'status', 'refunded' ), $current == 'refunded' ? 'current' : '', __( 'Refunded', 'yith-woocommerce-affiliates' ), YITH_WCAF_Commission_Handler()->per_status_count( 'refunded' )  ),
			);
		}
		...
		public function get_bulk_actions() {
			$actions = array(
                'pay'                       => __( 'Create a payment', 'yith-woocommerce-affiliates' ),
				'switch-to-pending'         => __( 'Switch to pending', 'yith-woocommerce-affiliates' ),
				'switch-to-not-confirmed'   => __( 'Switch to not confirmed', 'yith-woocommerce-affiliates' ),
				'switch-to-cancelled'       => __( 'Switch to cancelled', 'yith-woocommerce-affiliates' ),
				'switch-to-refunded'        => __( 'Switch to refunded', 'yith-woocommerce-affiliates' ),
			);
